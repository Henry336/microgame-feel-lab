...
const requiredFiles = ["index.html", "src/challenge.js", "src/config.js", "src/game.js", "src/styles.css"];
...
for (const token of ["gameCanvas", "challengeReadout", "./src/game.js", "./src/styles.css"]) {
